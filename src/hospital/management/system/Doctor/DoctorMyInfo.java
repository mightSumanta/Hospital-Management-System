 ...
 * @author Sumanta
 */
public class DoctorMyInfo extends javax.swing.JFrame {

    Connection conn = null;
    ResultSet rs = null;
    PreparedStatement pst = null;
    /**
     * Creates new form DoctorMyInfo
     */
    public DoctorMyInfo() {
        initComponents();
    ...
    private void initComponents() {
        ...
        txt_contactNo.setBounds(529, 281, 203, 33);
        jPanel1.add(txt_specialist);
        txt_specialist.setBounds(529, 230, 203, 33);
        jPanel1.add(txt_department);
        txt_department.setBounds(529, 179, 203, 33);

        txt_loginId.setEditable(false);
        jPanel1.add(txt_loginId);
        txt_loginId.setBounds(190, 230, 203, 33);
        jPanel1.add(txt_name);
        txt_name.setBounds(190, 180, 203, 33);

        jLabel1.setText("Login Id");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(60, 230, 100, 33);

        jLabel2.setText("Name");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(60, 180, 100, 33);

        jLabel3.setText("Confirm Password");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(60, 330, 115, 33);

        jLabel4.setText("Password");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(60, 280, 100, 33);

        jLabel5.setText("Department");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(417, 179, 100, 33);

        jLabel6.setText("Specialization");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(417, 230, 100, 33);

        jLabel7.setText("Contact No");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(417, 281, 100, 33);
        jPanel1.add(txt_confirmPassword);
        txt_confirmPassword.setBounds(190, 330, 203, 33);
        jPanel1.add(txt_password);
        txt_password.setBounds(190, 280, 203, 33);
        ...
        jButton1.setBounds(420, 430, 139, 53);
        ...
        jButton2.setBounds(260, 430, 150, 53);
        ...
        jButton3.setBounds(110, 430, 139, 53);
        ...
        jButton4.setBounds(570, 430, 139, 53);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String spec = txt_specialist.getText();
        ...
        if (txt_password.getText().equals(txt_confirmPassword.getText())) {
            if (x == 0) {
                try {
                    String sql = "update Doctor set name = ? ,loginId = ? ,password = ? ,department = ?" 
                            + " ,specialization = ? ,contactNo = ? where loginId = ?";
                    pst = conn.prepareStatement(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoctorMyInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DoctorMyInfo().setVisible(true);
            }
        });
    }
